    ...
    <div className='w-screen flex flex-col items-center justify-center'>
      ...
      <div className='flex'>
        ...
        <button
          ...
          disabled={loading}
          className={`px-4 py-1 flex items-center stroke-black hover:stroke-white bg-[#ffffff] text-black rounded-r-full shadow-md hover:bg-[#000000] hover:text-white focus:outline-none focus:ring-2 focus:bg-[#2e2e2e] ${loading ? 'opacity-50 cursor-not-allowed' : '' // Reduce opacity and disable cursor during download/conversion
            }`}
        >
      ...
      {message && <code className="mt-4 text-white bg-black p-3 rounded-lg">{message}</code>}
    </div>
  );
}
